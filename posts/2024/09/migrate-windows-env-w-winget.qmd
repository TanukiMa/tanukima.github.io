...
filters:
  - social-share
share:
  permalink: "https://TanukiMa.github.io/2024/09/migrate-windows-env-w-winget.html"
  description: "「wingetでWindows環境を移植」"
  twitter: true
  mastodon: true
---
...
ゴミも色々蓄積して、diskも足りなくなるし、**90日使い捨てWindows環境**というのは悪くないと思ってます。
